(() => {
  ...
  function at(t) {
    ...
    var M,
      O = Object.assign({ position: a }, l && rt),
      L =
        !0 === h
          ? (function (t, e) {
              var i = t.x,
  ...
  function gt(t, e) {
    ...
    var i = e,
      ...
      L = st({ reference: O, element: x, strategy: "absolute", placement: o }),
      E = vt(Object.assign({}, x, L)),
      U = p === K ? E : O,
      D = {
      ...
      if (x) {
        if (s) {
          var P,
            ...
            dt = D + et - at,
            lt = ht(u ? y(V, D + tt - at - rt) : V, D, u ? b(z, dt) : z);
          (x[S] = lt), (O[S] = lt - D);
        }
        if (a) {
          var ct,
            ...
            Ct = yt ? ft : mt - k[vt] - I[vt] - wt + _.altAxis,
    ...
    render(t) {
      ...
      n &&
        ...
        (this.children = u
          ...
          .append(...Tt.renderChildComments(t, this.level + 1, i))),
        (this.eCardSelf = u
          .div("card-self")
          .id(i)
          .append(
  ...
  class Bt {
    ...
    load() {
      const t = localStorage.getItem(Bt.StorageKey);
      if (t)
        try {
  ...
  Bt.StorageKey = "comentario_settings";
  class Ut {
    constructor(t, e, i, n) {
      (this.domainId = e),
        (this.pagePath = i),
  ...
  class Rt extends HTMLElement {
    constructor() {
      super(...arguments),
        (this.origin = "http://13.201.77.10:8080"),
        (this.cdn = "http://13.201.77.10:8080"),
      ...
      return t(this, void 0, void 0, function* () {
        ...
        this.scrollToCommentHash(),
          (null === (e = this.pageInfo) || void 0 === e
            ...
            : e.liveUpdateEnabled) &&
            this.liveUpdate &&
            new Ut(this.origin, this.pageInfo.domainId, this.pagePath, (t) =>
              this.handleLiveUpdate(t),
            ),
          console.info(
            `Initialised Comentario ${(null === (i = this.pageInfo) || void 0 === i ? void 0 : i.version) || "(?)"}`,
          ),
    ...
    renderComments() {
      this.commentsArea
        .html("")
        .append(
          ...Tt.renderChildComments(this.makeCommentRenderingContext(), 1),
        ),
        this.updateSortBar();
    }
    applySort(t) {
    ...
    loginOAuthPopup(e) {
      return t(this, void 0, void 0, function* () {
        ...
        if (!t)
          return (yield Nt.run(this.i18n.t, this.root, {
    ...
    openComentarioProfile() {
      return t(this, void 0, void 0, function* () {
        ...
        for (
          ...
          if (
            !(yield Nt.run(this.i18n.t, this.root, {
  ...
  customElements.define("comentario-comments", Rt);
})();
